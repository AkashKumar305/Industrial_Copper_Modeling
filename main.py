...
def predict_results(loaded_model, input_data):
    ...
    try:
        ...
        st.write('Predicted Result:',results)
...
def run_regression(df, loaded_model):
    ...
    input_labels = [
        'Quantity_Tons', 'Customer', 'Country', 'Status',
        'Application', 'Thickness', 'Width', 'Material_Ref',
        'Product_Ref', 'Purchased_Day', 'Purchased_Month', 'Purchased_Year',
        'Delivered_Month', 'Delivered_Year', 'Item_Type_IPL', 'Item_Type_Others',
        'Item_Type_PL', 'Item_Type_S', 'Item_Type_W', 'Item_Type_WI'
    ]
...
def run_classification(df, loaded_model):
    ...
    input_labels = [
        ...
        'Application', 'Thickness', 'Width', 'Material_Ref',
        'Product_Ref','Selling_price', 'Purchased_Day', 'Purchased_Month', 'Purchased_Year',
        'Delivered_Month', 'Delivered_Year', 'Item_Type_IPL', 'Item_Type_Others',
        'Item_Type_PL', 'Item_Type_S', 'Item_Type_W', 'Item_Type_WI'
    ]
